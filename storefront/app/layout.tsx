...
export const metadata: Metadata = {
  title: {
    default: 'Maison Lumière — Rare Niche Fragrances',
    template: '%s | Maison Lumière',
  },
  description: 'Hand-blended niche perfumes crafted in small batches from rare ingredients. Oud, rose, amber — from our atelier to you.',
}
